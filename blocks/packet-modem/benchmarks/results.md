...
`gr4-incubator` Docker container. The host operating system is Arch Linux.

The packet-modem benchmarks have been built using the default environment
variables in this repository. This uses clang 18.1.3 with no `-march`
